...
head -n 500000 csv/user.mlisovyi.9682261._000003.361023.JZ3W.DAOD_JETM6.csv >> ${target}
head -n 500000 csv/user.mlisovyi.9682259._000007.361024.JZ4W.DAOD_JETM6.csv >> ${target}
