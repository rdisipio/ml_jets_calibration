...
def create_model():
   ...
   model_pT.add( Dense(10, activation='linear'))
   ...
   model_eta.add( Dense(10, activation='linear'))
   ...
   model_M.add( Dense(10, activation='linear'))
   model_M.add( Dense(1, activation='linear'))

   merged = Merge( [ model_pT, model_eta, model_M ], mode='concat' )
...
dnn.fit( [ X_train_pT, X_train_eta, X_train_M ], y_train )
